...
var file_domain_order_order_proto_rawDesc = string([]byte{
...
var (
	...
	file_domain_order_order_proto_rawDescData []byte
)

func file_domain_order_order_proto_rawDescGZIP() []byte {
	file_domain_order_order_proto_rawDescOnce.Do(func() {
		file_domain_order_order_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_domain_order_order_proto_rawDesc), len(file_domain_order_order_proto_rawDesc)))
	})
...
var file_domain_order_order_proto_goTypes = []any{
...
func file_domain_order_order_proto_init() {
	...
	file_domain_order_order_proto_msgTypes[0].OneofWrappers = []any{}
	file_domain_order_order_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_domain_order_order_proto_rawDesc), len(file_domain_order_order_proto_rawDesc)),
			NumEnums:      3,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
