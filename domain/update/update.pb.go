...
var file_domain_update_update_proto_rawDesc = string([]byte{
...
var (
	...
	file_domain_update_update_proto_rawDescData []byte
)

func file_domain_update_update_proto_rawDescGZIP() []byte {
	file_domain_update_update_proto_rawDescOnce.Do(func() {
		file_domain_update_update_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_domain_update_update_proto_rawDesc), len(file_domain_update_update_proto_rawDesc)))
	})
...
var file_domain_update_update_proto_goTypes = []any{
...
func file_domain_update_update_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_domain_update_update_proto_rawDesc), len(file_domain_update_update_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
