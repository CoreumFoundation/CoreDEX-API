module github.com/CoreumFoundation/CoreDEX-API/coreum
...
replace (
	...
	github.com/coinbase/rosetta-sdk-go => github.com/coinbase/rosetta-sdk-go v0.8.4
...
require (
	github.com/CoreumFoundation/coreum/v5 v5.0.0-20250220192250-d6577f6429cf
